      ...
      <AnimatePresence mode="wait">
        {filteredPhotos.length > 0 ? (
            ...
            {filteredPhotos.map((photo, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative rounded-2xl overflow-hidden border border-[var(--border-secondary)] hover:border-[#d4af37]/50 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] ${
                    isTall ? 'row-span-2' : ''
                  } ${isWide ? 'col-span-2' : ''}`}
                >
          ...
          >
            ...
            <p className="text-[var(--text-secondary)] text-base font-medium">No photos found for this album.</p>
          </motion.div>
        )}
      </AnimatePresence>
